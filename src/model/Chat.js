...
export class Chat extends Model{
    ...
    static create(meEmail, contactEmail){
        ...
        return new Promise((s,f)=>{
            ...
            let users = {}; //users é um objeto

            users[btoa(meEmail)] = true; //meu email convertido em b64
            users[btoa(contactEmail)] = true; //email do contato convertido em b64
            ...
            }).catch(err=>{ f(err) }); //add vai gerar o id automaticamente 

...
export class Message extends Model {
    ...
    static send(chatId, from, type, content){
        ...
        return Message.getRef(chatId).add({
            ...
            type,
            from
        });//cria algumas informações passando um objeto. type é o tipo da mensagem e from de quem ela veio

    }//pega a referência do chat id e retorna a mensagem com o add
    ...
    }//constroi o caminho até o campo mensagens
